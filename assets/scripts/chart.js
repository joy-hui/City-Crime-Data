...
!(function (t, e) {
        ...
        if (
          ...
          if (n(g))
            for (d = 0, f = g.length; d < f; ++d)
              (v = g[d]),
                s(v) || n(v) || ((_ = De(o, b.data, b.gc, _, v)), (y += x));
        ...
        for (let f = e; f < e + i; f++) {
          const e = this.getParsed(f),
            ...
            m = {
              ...
              base: i.base,
              enableBorderRadius:
                !p || Tn(e._custom) || a === p._top || a === p._bottom,
              x: h ? i.head : g.center,
              y: h ? g.center : i.head,
      ...
      const n = (function (t, e) {
        ...
        for (
          ...
          (u && M !== a
            ? (i.push({ value: a }),
              M < a && D++,
              V(Math.round((M + D * S) * v) / v, a, lo(a, y, t)) && D++)
            : M < a && D++);
          D < k;
          ++D
        )
    ...
    determineDataLimits() {
      ...
      (this.min = a(t) ? Math.max(0, t) : null),
        ...
        this._zero &&
          ...
          !a(this._userMin) &&
          (this.min =
            t === fo(this.min, 0) ? fo(this.min, -1) : fo(this.min, 0)),
        this.handleTickRangeOptions();
    }
    handleTickRangeOptions() {
  ...
  function Go(t, e) {
    ...
    return (
      ...
      i.length
        ? new Zn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
        : null
    );
  }
  function Zo(t) {
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            o !== n &&
            (oa(t, s, a.top),
            aa(t, { line: i, target: s, color: n, scale: r, property: l }),
            t.restore(),
            t.save(),
            oa(t, s, a.bottom));
    ...
    afterDatasetsUpdate(t, e, i) {
      ...
      for (a = 0; a < s; ++a)
        (o = t.getDatasetMeta(a)),
          ...
          n.push(l);
      for (a = 0; a < s; ++a)
        (l = n[a]), l && !1 !== l.fill && (l.fill = Jo(n, a, i.propagate));
    },
    beforeDraw(t, e, i) {
